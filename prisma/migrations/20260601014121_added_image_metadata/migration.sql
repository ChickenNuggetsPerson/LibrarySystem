...
CREATE TABLE "new_Book" (
    ...
    "imageFileType" TEXT NOT NULL DEFAULT '',
    CONSTRAINT "Book_libraryuuid_fkey" FOREIGN KEY ("libraryuuid") REFERENCES "Library" ("uuid") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_Book" ("author", "description", "imageLink", "imageUpdated", "isbn", "libraryuuid", "pageCount", "title", "uuid") SELECT "author", "description", "imageLink", "imageUpdated", "isbn", "libraryuuid", "pageCount", "title", "uuid" FROM "Book";
DROP TABLE "Book";
